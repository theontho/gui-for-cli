...
export function localizationLabels(table = {}) {
  return {
    ...
    actionPrecheckDiskSpaceTitle:
      table["app.action.precheck.diskSpace.title"] ?? "Not enough free disk space",
    actionPrecheckDiskSpaceMessageFormat:
      table["app.action.precheck.diskSpace.messageFormat"] ??
      "Need %{required} GB free at %{path}, only %{available} GB available.",
    actionPrecheckDiskSpaceInfoTitle:
      table["app.action.precheck.diskSpace.infoTitle"] ?? "Disk space estimate",
    actionPrecheckDiskSpaceInfoFormat:
      table["app.action.precheck.diskSpace.infoFormat"] ??
