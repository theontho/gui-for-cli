...
export const bootstrapIconMap: Record<string, string> = {
...
export function normalizeIconSet(value: unknown): "emoji" | "platform" {
  return value === "emoji" ? "emoji" : "platform";
}

export function normalizeColorTheme(value: unknown): "system" | "light" | "dark" {
