...
- Python 3.11 or newer when running the experimental Python renderers. Tkinter needs a Python build with `tkinter`; wxPython is optional and installed by `make setup-wx`.
