...
SWIFTUI_APP="${SWIFTUI_APP:-$ROOT_DIR/DerivedData/Build/Products/Debug/GUI for CLI.app}"
SWIFTUI_EXE="${SWIFTUI_EXE:-$SWIFTUI_APP/Contents/MacOS/GUI for CLI}"
TAURI_APP="${TAURI_APP:-$ROOT_DIR/WebUI/src-tauri/target/release/bundle/macos/GUI for CLI WebUI.app}"
TAURI_EXE="${TAURI_EXE:-$TAURI_APP/Contents/MacOS/gui-for-cli-webui-tauri}"
FLUTTER_APP="${FLUTTER_APP:-$FLUTTER_WORKTREE/Apps/Flutter/build/macos/Build/Products/Release/gui_for_cli_flutter.app}"
FLUTTER_EXE="${FLUTTER_EXE:-$FLUTTER_APP/Contents/MacOS/gui_for_cli_flutter}"
SLINT_BIN="${SLINT_BIN:-$SLINT_WORKTREE/Apps/Slint/target/release/gui-for-cli-slint}"
...
BUILTIN_STRINGS="${BUILTIN_STRINGS:-$ROOT_DIR/Sources/GUIForCLICore/Resources/BuiltinStrings}"
