...
13. Keep all three Windows C# release paths available: clean Release for compatibility, ReadyToRun for a lower-risk optimized build, and NativeAOT for the fastest/smallest optimized package.
