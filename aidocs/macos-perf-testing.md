...
| --- | ---: | ---: | ---: | ---: | --- |
| Native SwiftUI macOS app | 9.2 MB | 0.85 s to first window after workspace-sync optimization | 67-80 MB physical footprint | ~0.01% | Lowest memory and smallest app; startup is now in the same sub-second class as WebUI shells. |
