...
public struct CommandRenderContext: Sendable {
  ...
  public var placeholderLabels: [String: String]
  ...
  public init(
    ...
    self.placeholderLabels = placeholderLabels
  }

  public func value(for placeholder: String) -> String? {
  ...
  public func interpolated(_ value: String) -> String {
    var result = value
    let pattern = #"\{\{([^}]+)\}\}"#
  ...
  public func label(for placeholder: String) -> String? {
