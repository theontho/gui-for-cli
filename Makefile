...
.PHONY: \
	...
	test test-webui test-flutter test-compose test-android test-gtk4 test-slint test-raygui test-imgui test-egui test-qt-qml test-fyne ax-smoke ax-smoke-ios ax-all \
	build-cli run-cli \
