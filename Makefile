...
.PHONY: \
	...
	test test-webui test-python test-textual smoke-textual smoke-tkinter smoke-wx test-toga test-flutter test-compose test-android test-gtk4 test-slint test-raygui test-imgui test-iced test-makepad test-egui test-gpui test-qt-qml test-avalonia test-fyne ax-smoke ax-smoke-ios ax-all \
	build-cli run-cli \
